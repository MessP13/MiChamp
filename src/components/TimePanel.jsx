...
export default function TimePanel({ simDate, setSimDate }) {
  // Esconder em produção a menos que explicitamente habilitado
  ...
  return (
    <div style={{ 
      ...
      {open && (
        <div className="animate-in" style={{ padding: "16px", borderTop: "1px solid var(--bd)", background: "rgba(0,0,0,0.2)" }}>
